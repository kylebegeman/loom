...
| `apps/server/src/fork/project-profiles/budget.test.ts`                | Delta rule (growth, session reset), crossing 80% and 100% once, both in one jump, no budget set; `serverLocalDay` puts 23:59 and 00:01 local on different days, a UTC-midnight crossing that is not a local one on the same day, and a DST change day.                                                                                                                                                                                                                                                |
