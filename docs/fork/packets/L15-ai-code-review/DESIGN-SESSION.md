...
History: superseded by [section 7](#7-decision-record).
...
## 5. Recommended v1 (before the session)
...
| Presentation (D)            | D1: a fork Review panel (launcher letter W) with runs, cards, filters and history. No inline diff annotations in v1.                                                                                                                                                                                                                                                                                                                                                                                            | No seam into the diff code view; "Open file" and "Open in diff" bridge the distance.                                                                                                                                                             |
