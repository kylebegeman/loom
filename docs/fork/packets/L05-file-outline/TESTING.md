...
| File                                                                                 | Covers                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/web/src/fork/file-outline/scanner.test.ts`                                     | Masking keeps length and newlines; comments and strings are blanked for every language config, including template literals with `${}`, Python triple-quoted strings and prefixes, Rust raw strings and lifetimes, Swift raw and multi-line strings, nested block comments (Swift, Rust).                                                                                                                       |
...
4. Edit the file in the editable surface: add a function; the outline updates without lag in
   typing.
5. Open a Swift, Python, Go, Rust and Markdown file in turn; the column stays open and follows.
...
- Outline accurate on the fixtures for all seven language ids.
