...
| L04 | [`thread-inspector`](./L04-thread-inspector/)             | One status card for the thread: work, changes, plan, approvals, agents and context.                                        | P6                           | core\*, root, panels, palette, keys                                             | Built; manual check pending |
