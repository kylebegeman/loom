...
| `apps/web/src/fork/small-extras/privateModeToast.test.ts`           | D      | The toast builder: title per case (automatic fix, names only, temporary branch), "Already pushed" line only when pushed, action choice (copy fix, copy reword, rename), expandable details list every finding.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
